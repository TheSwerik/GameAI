...
public class TestShakespeareRework : MonoBehaviour
{
    #region Attributes
    ...
    private WorkingAIRework.GeneticAlgorithm<char> _ga;
    ...
    private void Start()
    {
        ...
        _random = new Random();
        _ga = new WorkingAIRework.GeneticAlgorithm<char>(populationSize, targetString.Length, _random,
